...
public class MutationsList
{
    ...
    public MutationsList()
    {
        mutations = new Mutation[] {
                ...
                new Mutation(3, MutationType.Symptom, CharacterStates.Sneeze, "Sneeze", "Causes victims to sneeze and contaminate his hands. Creates airborn particles", 1, 3f, new Vector2(5f, 15f)),
